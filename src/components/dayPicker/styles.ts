export const wrapperStyle = "flex w-full items-center justify-between gap-4"
export const navigationButtonStyle = "cursor-pointer rounded border p-2 text-center"
...
export const availableIndicatorStyle = "mt-2 h-[5px] w-[18px] rounded border border-white bg-green-600"
