...
export default function DeleteServiceModal({ isOpen, setOpen, service }: { isOpen: boolean; setOpen: (open: boolean) => void; service: ServiceType }) {
      ...
      <Modal isOpen={isOpen} setOpen={setOpen} title="Excluir Serviço">
        <div className="space-y-6 p-2">
          <p className="text-gray-700">
            Tem certeza que deseja excluir o serviço <span className="font-semibold">{service.name}</span>? Esta ação não pode ser desfeita.
          </p>
